    ...
    def handle(self, *args, **kwargs):
        def scrape_news(url, base_url):
            ...
            try:
                ...
                self.stdout.write(self.style.ERROR(f"Failed to scrape {url}: {e}"))
                # Повернення порожнього списку у випадку помилки
                return []
        ...
        self.stdout.write(
            self.style.SUCCESS("Successfully scraped news and saved to JSON file")
        )
